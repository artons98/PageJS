...
class Page{
    ...
    initialize(){
        ...
        if ('serviceWorker' in navigator) {
            console.info('[PageJS] SW-registratie gestart ->');
            navigator.serviceWorker
                .register('/service-worker.js', { scope: '/' })
                .catch((e) => console.warn('[PageJS] SW-registratie mislukt:', e));
        }
    }
...
window.PageJSStylesURL = 'https://cdn.jsdelivr.net/gh/artons98/PageJS/dist/1.0.40/pageJS.css';
